...
% Acquisition parameters
    ...
    MRS_struct.p.ON_OFF_order = 'onfirst'; % order of editing pulses; options are 'onfirst' or 'offfirst'
...
% Analysis parameters
    ...
    MRS_struct.p.alignment     = 'Cr'; % alignment method; options are 'RobustSpecReg' (recommended), 'SpecReg', 'SpecRegHERMES',
